...
public class NPCRoom extends CaveRoom {
	...
	/**
	 * there is already a method like this, but to me it is helpful to have this other
	 * way of referring to it, ESPECIALLY
	...
	//the methods below REPLACE CaveRoom method(override)
